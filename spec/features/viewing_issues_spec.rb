...
feature "Users can view issues" do 
  ...
  before do
    ...
    FactoryGirl.create(:issue, platform: caliber, priority:'P1', author: author, subject: 'Caliber is down', issue: 'Caliber is dahn', impact: 'this is bad', status: status)

    sap = FactoryGirl.create(:platform, name: 'SAP')
    FactoryGirl.create(:issue, platform: sap, priority:'P3', author: author, subject: 'SAP is slow', issue: 'peeps cannnot see reports', impact: 'this is not terrible', status: status)
